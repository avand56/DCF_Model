...
def cb():
    return gm(request.args.get('data'), float(request.args.get('growth_rate')), float(request.args.get('terminal_growth')), int(request.args.get('iterations')), float(request.args.get('risk_free_rate')), float(request.args.get('beta')), float(request.args.get('market_rate_return')))
